        ...
        return panel {
            ...
            row("Snapshot search depth:") {
                spinner(1..10, 1)
                    ...
                    .applyToComponent {
                        // Explicit accessible name so UI tests can locate the
                        // spinner via `byXpath(".//div[@accessiblename='...']")`
                        // without depending on UI DSL `labelFor` propagation.
                        accessibleContext.accessibleName = "Snapshot search depth"
                    }
            }
            row {
                checkBox("Auto-reload on file change")
                    ...
                    .applyToComponent {
                        accessibleContext.accessibleName = "Auto-reload on file change"
                    }
            }
            row("Highlight color:") {
                ...
                textField()
                    ...
                    .applyToComponent {
                        accessibleContext.accessibleName = "Highlight color"
                        document.addDocumentListener(object : DocumentListener {
            ...
            row("Code generation style:") {
                comboBox(listOf("Property", "Variable"))
                    ...
                    .applyToComponent {
                        accessibleContext.accessibleName = "Code generation style"
                    }
            }
        }
    }
