...
- Plugin loader: `SnapshotBundle.kt` — `SUPPORTED_BUNDLE_VERSION` constant + `SnapshotBundle.load()` returning `BundleLoadResult.UnsupportedVersion` for unsupported bundles
