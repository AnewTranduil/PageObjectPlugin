...
- **Task 15 (Extract `@pagemirror/snapshot-core`):** the
  framework-agnostic `packages/snapshot-core/` package owns bundle
  assembly. Bundle format bumped to **v2**: `screenshot.<ext>` lives
